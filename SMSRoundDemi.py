...
class Big_window(): #Register
    ...
    with open ('dbRoundDemi_P_list.json','r') as mylist:
        data=mylist.read()
    ...
    def __init__(self, window,title, geometry, bg_color, message):
       # personnaliser la fenêtre
        ...
        """ Match_lable """
        lbl_fMatch = Label(Outer_Frame, text="First Match", bg=background_color2,fg=background_color,font=("lato",50,"bold"))
        lbl_fMatch.grid(row=0, column=0, pady=50, padx=100)
        lbl_sMatch = Label(Outer_Frame, text="Second Match", bg=background_color2,fg=background_color,font=("lato",50,"bold"))
